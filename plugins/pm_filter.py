...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴅᴏɴᴀᴛᴇ ꜰᴏʀ ɪᴘᴏᴘᴄᴏʀɴ 🍿', callback_data='donate')
	],[
        ...
        buttons = [[
            InlineKeyboardButton("ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ʀᴇᴄᴇɪᴘᴛ 🧾", url="https://t.me/IllegalDeveloperBot")
        ]]
        reply_markup = InlineKeyboardMarkup(buttons) 
        await query.message.edit_text(
        ...
        await query.message.reply_photo(
            photo="https://graph.org/file/6e3df89cb8a1cc04d2452.jpg",
	    ...
	    InlineKeyboardButton("UPI ID", callback_data = "upi"),
            ...
            InlineKeyboardButton("🧛 Contact To Admin", url="https://t.me/IllegalDeveloperBot")
	],[
        ...
        btn = [[
            ...
            InlineKeyboardButton("📸 Sᴇɴᴅ Yᴏᴜʀ Pᴀʏᴍᴇɴᴛ Sᴄʀᴇᴇɴꜱʜᴏᴛ 📸", url="https://t.me/IllegalDeveloperBot")  
        ],[
            InlineKeyboardButton("⇐ Back", callback_data="premium"),
            InlineKeyboardButton("☏ ᴄᴏɴᴛᴀᴄᴛ", url=f"https://t.me/IllegalDeveloperBot")  
        ]]
        reply_markup = InlineKeyboardMarkup(btn)
        await query.message.reply_photo(
    ...
    if offset != "":
        if total_results >= 3:
            ...
            btn.insert(0,[
                ...
                InlineKeyboardButton("📰 ʟᴀɴɢᴜᴀɢᴇꜱ", callback_data=f"languages#{key}#0#{req}")
            ])
    else:
        if total_results >= 3:
            btn.insert(0,[
